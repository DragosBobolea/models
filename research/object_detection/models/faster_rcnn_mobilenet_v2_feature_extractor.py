...
class FasterRCNNMobilenetV2FeatureExtractor(
    ...
    def _extract_proposal_features(self, preprocessed_inputs, scope):
        ...
        with tf.variable_scope('MobilenetV2', reuse=self._reuse_weights) as scope:
            with  slim.arg_scope([mobilenet.depth_multiplier], min_depth=self._min_depth, final_endpoint='layer_14'):
    ...
    def _extract_box_classifier_features(self, proposal_feature_maps, scope):
        ...
        with tf.variable_scope('MobilenetV2', reuse=self._reuse_weights):
            with slim.arg_scope(mobilenet_v2.training_scope(is_training=self._train_batch_norm, weight_decay=self._weight_decay)):
